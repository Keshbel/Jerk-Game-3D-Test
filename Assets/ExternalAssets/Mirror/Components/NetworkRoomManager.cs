...
namespace Mirror
{
    ...
    public class NetworkRoomManager : NetworkManager
    {
        ...
        [SerializeField]
        [FormerlySerializedAs("m_RoomSlots")]
        ...
        public override void OnServerAddPlayer(NetworkConnectionToClient conn)
        {
            ...
            if (IsSceneActive(RoomScene))
            {
                ...
                if (newRoomGameObject == null)
                {
                    ...
                    newRoomGameObject.name = newRoomGameObject.name[..^7];
                    if (newRoomGameObject.name == "Player")
                        newRoomGameObject.name = "Player" + clientIndex;
                }
